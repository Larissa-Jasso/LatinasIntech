    ...
    <Layout>
      <Header className="first-header background-header">
        <Menu mode="horizontal" className="menu">
          ...
          <Menu.SubMenu key="2" title="Founders & Investors" icon={<CaretDownOutlined />}>
            <Menu.Item key="Sub3">Submenu 3</Menu.Item>
            <Menu.Item key="Sub4">Submenu 4</Menu.Item>
          </Menu.SubMenu>
          <Menu.SubMenu key="1" title="Get Involved" icon={<CaretDownOutlined />}>
      ...
      <Avatar  src={<Image src="/images/Logo.png" preview={false} />} className="logo" />
        ...
        >         
          ...
          <Menu.Item key="12">
          <Avatar src={<Image src="/images/Envelope.png" style={{ width: "100%" }} preview={false} />} />
          </Menu.Item>
          <Menu.Item key="11" >
          LiT Community
          </Menu.Item>
          ...
          <Menu.SubMenu key="8" title="LiT Recruit" icon={<CaretDownOutlined />} >
